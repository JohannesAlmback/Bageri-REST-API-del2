        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryPotalCode = table.Column<string>(type: "TEXT", nullable: false),
                    DeliveryCity = table.Column<string>(type: "TEXT", nullable: false),
                    InvoiceAddress = table.Column<string>(type: "TEXT", nullable: false),
                    InvoicePostalCode = table.Column<string>(type: "TEXT", nullable: false),
                    InvoiceCity = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerKilo = table.Column<double>(type: "REAL", nullable: false),
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierPrices", x => new { x.SupplierId, x.CommodityId });
                    table.ForeignKey(
                        name: "FK_SupplierPrices_Commodities_CommodityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPrices_CommodityId",
